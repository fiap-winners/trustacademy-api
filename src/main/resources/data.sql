INSERT INTO institutes(id, name, code, created_at, modified_at) VALUES
  (1001, 'Faculdade de Informática e Administração Paulista', 'FIAP', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO courses(id, name, department_id, created_at, modified_at) VALUES
  (1001, 'Análise e Desenvolvimento de sistemas', 1001, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1002, 'Marketing Digital', 1001, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1003, 'Engenharia da Computação', 1002, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1004, 'Engenharia de Produção', 1002, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO documents(id, student_id, institute_id, department_id, course_id, document_type_id, content, created_at, modified_at) VALUES
  (1001, 1001, 1001, 1001, 1001, 1001, 'Conteúdo a v1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1002, 1001, 1001, 1001, 1001, 1001, 'Conteúdo a v2', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1003, 1002, 1001, 1001, 1001, 1002, 'Conteúdo b v1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1004, 1002, 1001, 1001, 1001, 1002, 'Conteúdo b v2', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1005, 1002, 1001, 1001, 1001, 1002, 'Conteúdo b v3', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
